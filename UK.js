AddLanguage('UK','ukrainian',{
	...
	"heavenly chip": "небесна крихта",
	"wrinkler": "зморшник",
	"building": "будівля",
	"upgrade": "покращення",
	"golden cookie": "золоте печиво",
	"grandmapocalypse": "бабцепокаліпсис",
	"%1 cookie": [
		"%1 печиво",
		"%1 печива"
	],
	...
	"Don't show this again": "більше не показувати",
	"Delete all": "видалити все",
	"Back": "назад",
	"Confirm": "підтвердити",
	"All done!": "все зроблено",
	"Load": "відкрити",
	"Save": "зберегти",
	"Quit": "вийти",
	...
	"Click": "клік",
	"Shift": "шифт",
	"Shift-click": "шифт-клік",
	"Ctrl": "контрол",
	"Ctrl-click": "контрол-клік",
	"Esc": "ескейп",
	"Cookies": "печива",
	"%1 day": [
		"%1 дн",
	...
	"less than 1 second": "менше ніж 1 с",
	"in %1": "через %1",
	"%1 ago": "%1 назад",
	"%1 remaining": "залишилось %1",
	"%1 worth": "коштує %1",
	"%1 of CpS": "%1 від пвс",
	"%1% of bank": "%1% банку",
	"per second:": "в секунду",
	"just now": "щойно",
	"a long while": "дуже давно",
	"forever": "назавжди",
	"Time remaining:": "залишилось часу:",
	"Big clickable cookie": "велике клікабельне печиво",
	"Golden cookie": "золоте печиво",
	...
	"ON": "вмк",
	"OFF": "вимк",
	"Fancy graphics": "красива графіка",
	"CSS filters": "фільтри css",
	"visual improvements; disabling may improve performance": "визуальні покращення; вимкнення може поліпшити швидкодію",
	"Particles": "частинки",
	"Numbers": "числа",
	"numbers that pop up when clicking the cookie": "які з'являються при натисканні печива",
	"Milk [setting]": "молоко",
	"Cursors [setting]": "курсори",
	"visual display of your cursors": "їхнє візуальне відображення",
	"Wobbly cookie": "хитке печиво",
	"Alt cookie sound": "інший звук печива",
	"Icon crates": "рамки",
	"display boxes around upgrades and achievements in Stats": "навколо покращень та досягнень на сторінці статистики",
	"Alt font": "інший шрифт",
	"your cookies are displayed using a monospace font": "моноширинний",
	"Short numbers": "короткі числа",
	"Fast notes": "швидкі сповіщення",
	"notifications disappear much faster": "зникатимуть набагато швидше",
	"Closing warning": "попередження закриття",
	"the game will ask you to confirm when you close the window": "при закритті гри буде попередження",
	"Defocus": "разфокусування",
	"the game will be less resource-intensive when out of focus": "гра буде споживати менше ресурсів",
	"Extra buttons": "додаткові кнопки",
	"add options on buildings like Mute": "на будівлях, напиклад сховати",
	"Lump confirmation": "попередження шматочків",
	"the game will ask you to confirm before spending sugar lumps": "перед тратою шматочків цукру гра питатиме вас",
	"Custom grandmas": "користувацькі бабусі",
	"some grandmas will be named after Patreon supporters": "названі підтримувачами на patreon",
	"Scary stuff": "страшні речі",
	"Sleep mode timeout": "таймаут сну",
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode": "на повільних комп'ютерах, гра спатиме, коли стане неактивною та почне зависати, в цей час почнеться офлайн-продукція печива",
	"Music in background": "фонова музика",
	"music will keep playing even when the game window isn't focused": "гратиме, навіть якщо вікно гри неактивне",
	"Cloud saving": "хмарне збереження",
	"allow use of Steam Cloud for save backups": "дозволятиме зберігати гру в steam cloud",
	"Purge Cloud": "очистити хмару",
	"Current Cloud use:": "поточне користання хмари:",
	"No Cloud access at the moment.": "зараз нема доступу до хмари.",
	"Screen reader mode": "режим читання екрану",
	"allows optimizations for screen readers; game will reload": "оптимізує гру для читачів екрану та перезавантажить її",
	"Discord status": "статус в discord",
	"if Discord is on, show your game info as activity status": "якщо discord працює, показуватиме гру як статус активности",
	"Language": "мова",
	"Language: %1": "мова: %1",
	"Change language": "змінити мову",
	"note: this will save and reload your game": "увага: збереже та перезавантажить гру.",
	"Press %1 to toggle fullscreen.": "натисніть %1, щоб розгорнути на увесь екран.",
	"Other versions": "інші версії",
	"Beta": "бета",
	"Stats": "статистика",
	"Shadow achievements": "тіневі досягнення",
	"These are feats that are either unfair or difficult to attain. They do not give milk.": "ці досягнення або дуже складні, або просто нечесні. вони не приносять молоко.",
	"starter milk": "молоко для початківця",
	"for %1 achievements": "за %1 досягнень",
	"appeased": "спокійний",
	"awoken": "пробуджений",
	"displeased": "незадоволений",
	"angered": "розлючений",
	"Cookies in bank:": "печива в банку:",
	"Cookies baked (this ascension):": "приготовано печива (за це вознесіння):",
	"Cookies baked (all time):": "приготовано печива (за весь час):",
	"Cookies forfeited by ascending:": "загублено печива через переродження:",
	"Legacy started:": "наслідство почато:",
	"with %1 ascension": [
		"з %1 вознесіння",
		"з %1 вознесінь"
	],
	"Run started:": "гра почалась:",
	"Buildings owned:": "будівель куплено:",
	"Cookies per second:": "печива в секунду:",
	"Raw cookies per second:": "печива в секунду без множників:",
	"highest this ascension:": "макс. за це возесіння:",
	"multiplier:": "множник:",
	"withered:": "засихші:",
	"Cookies per click:": "печива на клік:",
	"Cookie clicks:": "кліків печива:",
	"Hand-made cookies:": "печива ручної роботи:",
	"Golden cookie clicks:": "кліків по золотому печиву:",
	"Random drop multiplier:": "множник випадкового випадіння:",
	"all time:": "за весь час:",
	"Running version:": "версія:",
	"Special": "особливе",
	"Challenge mode:": "режим випробування:",
	"Seasonal event:": "сезонна подія:",
	"Research:": "дослідження:",
	"Grandmatriarchs status:": "статус бабцематріархів:",
	"Pledge:": "займа:",
	"Wrinklers popped:": "лопнуто зморшників:",
	"Sugar lumps harvested:": "зібрано шматочків цукру:",
	"Reindeer found:": "знайдено оленів:",
	"Santa stages unlocked:": "розблоковано стадій санти:",
	"Dragon training:": "навчання дракона:",
	"Prestige": "престиж",
	"at %1% of its potential <b>(+%2% CpS)</b>": "при %1% потенціалу <b>(+%2% печ/с)</b>",
	"Prestige upgrades unlocked:": "розблоковано покращень престижу:",
	"Upgrades unlocked:": "розблоковано покращень:",
	"Achievements unlocked:": "розблоковано досягнень:",
	"Kitten multiplier:": "множник котів:",
	"Milk": "молоко",
	"Milk:": "молоко:",
	"Milk flavors unlocked:": "розблоковано смаків молока:",
	"Milk is gained with each achievement. It can unlock unique upgrades over time.": "молоко дається з кожним досягненням. воно може відкрити унікальні покращення з часом",
	"Rank %1": "ранг %1",
	"Automatic": "автоматично",
	"Plain milk": "звичайне молоко",
	"Chocolate milk": "шоколадне молоко",
	"Raspberry milk": "малинове молоко",
	...
	"Zebra milk": "смугасте молоко",
	"Cosmic milk": "космічне молоко",
	"Flaming milk": "вогняне молоко",
	"Sanguine milk": "криваве молоко",
	"Midas milk": "зоряне молоко",
	"Midnight milk": "північне молоко",
	"Green inferno milk": "зелено-пекельне молоко",
	"Frostfire milk": "холодно-вогняне молоко",
	"Honey milk": "медове молоко",
	"Coffee milk": "кавове молоко",
	"Tea milk": "чайне молоко",
	...
	"Mint milk": "м'ятне молоко",
	"Licorice milk": "лакричне молоко",
	"Rose milk": "трояндове молоко",
	"Dragonfruit milk": "пітайове молоко",
	"Peach milk": "персикове молоко",
	"Hazelnut milk": "фундучне молоко",
	"Info": "інформація",
	"About": "про гру",
